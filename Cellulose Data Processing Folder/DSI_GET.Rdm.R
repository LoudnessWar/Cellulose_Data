...
Final output, combinging them all and putting them into a table or whatever with the names of the DSIs and the other junk
...
write.csv(finalDF, "smellynuts.csv", row.names = TRUE)
